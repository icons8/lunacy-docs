...
* We've integrated the avatar tool with our <a href="https://generated.photos/" target="_blank">generated.photos</a>. project. Now you can select between the photos of real-life models (default) and photos of people generated by our AI. In the latter case you can choose the desired gender, age, ethnicity, and hair color of a model. Then click Generate avatar and enjoy the magic!
...
Download from the <a href="https://www.microsoft.com/store/apps/9pnlmkkpcljj?ocid=badge" target="_blank">Microsoft Store</a> or click [here](https://desktop.icons8.com/lunacy/LunacySetup_6.2.0.exe) to get the Installer.
