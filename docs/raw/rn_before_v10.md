...
If you also want to take part in Lunacy localization, click <a href="https://lunacy.docs.icons8.com/raw/localization.md" target="_blank">here</a>.
...
More about <a href="https://lunacy.docs.icons8.com/raw/teams.md" target="_blank">teams in Lunacy</a>.
...
For details, about teams read <a href="https://lunacy.docs.icons8.com/raw/teams.md" target="_blank">here</a>.
...
For details, click <a href="https://lunacy.docs.icons8.com/raw/prototyping.md" target="_blank">here</a>.
...
For details about working with plugins in Lunacy, read <a href="https://lunacy.docs.icons8.com/raw/plugins.md" target="_blank">here</a>.
...
For details and a demo, click <a href="https://lunacy.docs.icons8.com/raw/styling.md#tint-overrides" target="_blank">here</a>.
...
For details about using the panels, read <a href="https://lunacy.docs.icons8.com/raw/styling.md#suggestions-panel" target="_blank">here</a> and <a href="https://lunacy.docs.icons8.com/raw/text.md#suggestions-panel" target="_blank">here</a>.
...
To edit the appearance of a control, use the <a href="https://lunacy.docs.icons8.com/raw/components.md#editing-main-components" target="_blank">symbol editor</a>.
...
For details and a demo, click <a href="https://lunacy.docs.icons8.com/raw/components.md#editing-main-components" target="_blank">here</a>.

#### Smart distribute

Now you can quickly arrange multiple objects into nice grids with equal spacing between rows and columns.

For this, select the objects and click the **Tidy up** button in the Inspector. Then drag the red handles that will appear between the "rows" and "columns". Click the red circle in the center of an object and drag to move it to another grid "cell". For details and a demo, click <a href="https://lunacy.docs.icons8.com/raw/objects.md#smart-distribute" target="_blank">here</a>.
...
- [Help!](https://lunacy.docs.icons8.com/raw/lunacy-docs) 
...
- Export projects to [Sketch the Ripper](https:.md/icons8.com/articles/sketch-ripper-free-tool-rip-sketch-file-contents/)
- Zoom to area tool
