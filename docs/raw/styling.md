...
You can apply them to all <a href="https://lunacy.docs.icons8.com/raw/layers.md#introduction" target="_blank">types of layers</a>, except for <a href="https://lunacy.docs.icons8.com/raw/tools.md#hotspot-tool" target="_blank">hotspots</a>, and <a href="https://lunacy.docs.icons8.com/raw/tools.md#slice-tool" target="_blank">slices</a>, though not all layers have all of the styling options available. For example, groups have [tints](#tints) instead of [fills](#fills), and <a href="https://lunacy.docs.icons8.com/raw/components.md#managing-instances" target="_blank">component instances</a> have both these options.

Save time by <a href="https://lunacy.docs.icons8.com/raw/layerstyles.md" target="_blank">creating layer styles</a> for individual or multiple styling options. You can easily reuse them across different layers, keeping your designs consistent.

**See also:**<br>
<a href="https://lunacy.docs.icons8.com/raw/layerstyles.md" target="_blank">Layer and text styles</a>
...
**See also:**<br>
<a href="https://lunacy.docs.icons8.com/raw/tools.md#avatar-tool" target="_blank">Avatar tool</a><br>
<a href="https://lunacy.docs.icons8.com/raw/tips.md" target="_blank">Tips and tricks</a>
...
Read <a href="https://lunacy.docs.icons8.com/raw/components.md#tint-overrides" target="_blank">more about tint overrides</a> in the <a href="https://lunacy.docs.icons8.com/raw/components.md" target="_blank">Components</a> page.
