...
You can also use this command to <a href="https://lunacy.docs.icons8.com/raw/text.md#converting-text-to-outlines" target="_blank">convert text layers to vector outlines</a>.
