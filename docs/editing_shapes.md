...
To **switch between default round and smooth corners**, click <embed type="image/svg+xml" alt="Checkbox button" src="https://cdn-eu.icons8.com/docs/Dko8QE6mZ06fz2gAGGUBbA/EHJ49v8Yo0S0JSrN3k3hcw.svg" width="48" /> next to the corner radius button in the right panel.
...
4. On the **context toolbar**, click the **Toggle mask** button (<embed type="image/svg+xml" alt="Toggle mask Actions" src="https://cdn-eu.icons8.com/docs/Dko8QE6mZ06fz2gAGGUBbA/8uNAx83h7ky5F0iXcwWaxQ.svg" width="48" /> 
