...
- To invert a gradient, use the <embed type="image/svg+xml" alt="invert_gradient" src="https://cdn-eu.icons8.com/docs/Dko8QE6mZ06fz2gAGGUBbA/T7iYJfnlx0mNx1Vl9048fA.svg" width="20" /> button next to the gradient bar.
